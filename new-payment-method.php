            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        <div class="head">
                            <a href="payment-method.php" class="back-btn"><i class="fa-regular fa-arrow-left"></i></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="number" name="number" placeholder="4000 0000 0000 1000" class="form-control" required minlength="16" maxlength="16">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                        <div class="form-group">
